...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{chapters/images/overview-page/overview-1.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\textwidth]{chapters/images/overview-page/credentials-tab.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{chapters/images/overview-page/executions-tab.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\textwidth]{chapters/images/overview-page/disabled-overview.png}
