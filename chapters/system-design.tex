...
\begin{landscape}
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.9\paperheight,height=0.9\paperwidth,keepaspectratio]{images/erd/conceptual-erd.png}
...
\begin{landscape}
  \begin{figure}[H]
      \centering
      \includegraphics[width=0.9\paperheight,height=0.9\paperwidth,keepaspectratio]{images/erd/physical-erd.png}
      \caption{Physical Entity Relationship Diagram (CERD) for the FLOO platform}
      \label{fig:perd}
  \end{figure}
\end{landscape}
...
\section{Metadata-Based Communication}
...
\section{Optimized Output Handling}
